...
class PostController extends Controller
{
    ...
    {
        $user = \Auth::user();
        // $posts = Post::aviable()->orderBy('created_at', 'desc')->withCount(["zans", "comments"])->with('user','comments')->paginate(10);//with为预加载
        $posts = Post::orderBy('created_at', 'desc')->withCount(["zans", "comments"])->with('user','comments')->paginate(10);//with为预加载
//        p($posts);
