...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('adminlte')); ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(URL::asset('adminlte')); ?>/index2.html">ylaravel管理后台</a>
    </div>
    <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?php echo e(URL::asset('adminlte')); ?>/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
