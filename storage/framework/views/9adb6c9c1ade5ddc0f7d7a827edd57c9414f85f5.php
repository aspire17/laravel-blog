<div class="blog-masthead">
    <div class="container">
        <form action="<?php echo e(url('posts/search')); ?>" method="GET">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a class="blog-nav-item " href="<?php echo e(url('posts')); ?>">首页</a>
            </li>
            <li>
                <a class="blog-nav-item" href="<?php echo e(url('posts/create')); ?>">写文章</a>
            </li>
            <li>
                <a class="blog-nav-item" href="<?php echo e(url('notices')); ?>">通知</a>
            </li>
            <li>
            ...
            <li class="dropdown">
                <div>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(url('user',[$user->id])); ?>">我的主页</a></li>
                        <li><a href="<?php echo e(url('user/'.$user->id.'/setting')); ?>">个人设置</a></li>
                        <li><a href="<?php echo e(url('logout')); ?>">登出</a></li>
                    </ul>
                </div>
            </li>
        </ul>
