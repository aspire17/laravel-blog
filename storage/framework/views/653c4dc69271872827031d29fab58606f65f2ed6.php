<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo e(URL::asset('adminlte')); ?>/index2.html" class="logo">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <a href="<?php echo e(URL::asset('adminlte')); ?>/#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
