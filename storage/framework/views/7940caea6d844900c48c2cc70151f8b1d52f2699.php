...
<head>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('adminlte')); ?>/plugins/morris/morris.css">
    <!-- jvectormap -->
...
<script src="<?php echo e(URL::asset('adminlte')); ?>/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
...
<script src="<?php echo e(URL::asset('adminlte')); ?>/dist/js/pages/dashboard.js"></script>
