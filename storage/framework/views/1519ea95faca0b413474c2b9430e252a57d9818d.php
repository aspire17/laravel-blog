<?php $__env->startSection("content"); ?>
    ...
    <div class="col-sm-8">
        <blockquote>
            ...
            <footer>文章：<?php echo e($topic->posts()->count()); ?></footer>
            <button class="btn btn-default topic-submit"  data-toggle="modal" data-target="#topic_submit_modal" topic-id="<?php echo e($topic->id); ?>" _token="<?php echo e(csrf_token()); ?>" type="button">投稿</button>
        </blockquote>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/topic/<?php echo e($topic->id); ?>/submit">
